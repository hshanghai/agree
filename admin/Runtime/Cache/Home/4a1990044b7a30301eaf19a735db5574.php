...
<!-- start: Content -->
			...
			<ul class="breadcrumb">
				...
				<li><a href="<?php echo u('admin/Activity/listActivity');?>">活动列表</a></li>
			</ul>

			<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon user"></i><span class="break"></span>活动列表</h2>
						
						<div class="box-icon">
							<a href="?m=admin&c=activity&a=createActivity" title="添加文章"><i class="halflings-icon plus"></i></a>
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  ...
						  <tbody>
							<?php if(is_array($info)): foreach($info as $key=>$vo): ?><tr>
								...
								<td class="center"><?php echo ($vo["total"]); ?></td>
								<td class="center"><?php echo ($vo["support"]); ?></td>
								<td class="center">
									<?php if($vo["activity_switch"] == 1): ?><span class="label label-success">开启</span>
									<?php else: ?>
									<span class="label label-important" style="color:#000;">关闭</span><?php endif; ?>
								</td>
								<td class="center">
									<?php if($vo["activity_switch"] != 1): ?><a class="btn btn-info" href="?m=admin&c=activity&a=delactivity&id=<?php echo ($vo["id"]); ?>&activity_switch=1">
										<i class="halflings-icon white ok"></i>  
									</a>
									<?php else: ?>
									<a class="btn btn-danger" href="?m=admin&c=activity&a=delactivity&id=<?php echo ($vo["id"]); ?>&activity_switch=2">
